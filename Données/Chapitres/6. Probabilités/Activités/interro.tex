...
\fancyhead[C]{Interrogation}
\fancyhead[R]{Mardi 28 mars 2017}
...
\begin{itemize}
 \item Donner une formulation type pour justifier qu'une variable aléatoire suit une loi binomiale.
 \item Expliquer à quoi correspondent les paramètres $n$ et $p$ d'une loi binomiale $B(n,p)$.
 \item Soit $x=(x_i,n_i)_{1 \leq i \leq 13}$ une série statistique. Donner une formule littérale permettant de calculer:
 \begin{itemize}
 \item La moyenne de cette série.
 \item L'écart-type de cette série.
 \end{itemize}
 \item Rappeler le théorème permettant d'étudier le signe d'un trinôme du second degré.
