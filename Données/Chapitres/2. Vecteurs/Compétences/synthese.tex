...
\begin{document}
  ...
  \begin{enumerate}
   ...
   \item $ABCD$ est un parallélogramme $\Leftrightarrow \vec{AB}=\vec{DC}$ $\Leftrightarrow \vec{AC}=\vec{AB}+\vec{AD}$.
   \item $I$ est le milieu de $[AB] \Leftrightarrow \vec{IA}+\vec{IB}=\vec{0} \Leftrightarrow 2\vec{AI}=\vec{AB}$.
  \end{enumerate}
