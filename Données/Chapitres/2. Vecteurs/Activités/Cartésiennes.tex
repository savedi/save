...
%\headheight 15.0 pt
\fancyhead[L]{}
\fancyhead[C]{Equations cartésiennes de droites.}
\fancyhead[R]{}
...
\begin{document}
 ...
 Etant donné un repère $(O;\vec{i},\vec{j})$
\begin{enumerate}
 \item En utilisant la colinéarité, trouver une équation à la droite $D_{A,\vec{u}}$ passant par le point $A(2;5)$ et dirigée par le vecteur $\vec{u}(1;2)$.
 \item En utilisant la colinéarité, trouver une équation à la droite $(AB)$ avec $A(3;2)$ et $B(1;4)$.
 \item Montrer que l'ensemble $E$ d'équation $E:2x+y+3=0$ est une droite passant par le point $C(-1;-1)$ et dirigée par le vecteur $\vec{v}(-1;2)$.
 \item Montrer qu'une droite ayant $\vec{u}(-b;a)$ pour vecteur directeur admet une équation de la forme $ax+by+c=0$. 
 \item Montrer que $E:ax+by+c=0$ est une droite dirigée par $\vec{u}(-b;a)$.
\end{enumerate}
