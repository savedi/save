...
\begin{document}
 ...
 \begin{theorem}
  ...
  \begin{itemize}
   \item Si $q > 1$ et $u_k>0$ alors $(u_n)$ est strictement \uncover<2,3,4,5,6,7>{croissante}.
   \item Si $q > 1$ et $u_k\uncover<3,4,5,6,7>{<}0$ alors $(u_n)$ est strictement décroissante.
   \item Si $q = 1$ alors $(u_k)$ est \uncover<4,5,6,7>{constante}.
   \item Si $0 < q < 1$ et $u_k\uncover<5,6,7>{>}0$ alors $(u_n)$ est strictement décroissante.
   \item Si $0 < q < 1$ et $u_k<0$ alors $(u_n)$ est strictement \uncover<6,7>{croissante}.
